...
import type { Recommendation, RecommendationSignals } from "./recommend";
...
const SIGNALS: RecommendationSignals = { warmthLevel: 0, highUv: false, windAmplified: false, isHot: false };
