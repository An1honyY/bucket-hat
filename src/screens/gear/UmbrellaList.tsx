    ...
    <View style={styles.container}>
      {items.length === 0 ? (
        <View style={styles.emptyContainer}>
          ...
          <AppButton label="Add umbrella" layout="hug" onPress={() => navigation.navigate("GearItem", { kind: "umbrella" })} style={styles.addButton} />
        </View>
      ) : (
        <FlatList
          data={items}
          ...
          ListHeaderComponent={
            <AppButton label="Add umbrella" variant="secondary" layout="hug" onPress={() => navigation.navigate("GearItem", { kind: "umbrella" })} style={styles.listAddButton} />
          }
          renderItem={({ item }) => {
